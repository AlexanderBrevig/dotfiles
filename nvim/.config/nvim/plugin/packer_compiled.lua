...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    loaded = true,
    path = "/home/alexander/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  ["indent-blankline.nvim"] = {
    loaded = true,
    path = "/home/alexander/.local/share/nvim/site/pack/packer/start/indent-blankline.nvim",
  ...
  ["nlsp-settings.nvim"] = {
    loaded = true,
    path = "/home/alexander/.local/share/nvim/site/pack/packer/start/nlsp-settings.nvim",
  ...
  ["project.nvim"] = {
    loaded = true,
    path = "/home/alexander/.local/share/nvim/site/pack/packer/start/project.nvim",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/alexander/.local/share/nvim/site/pack/packer/start/vim-bbye",
